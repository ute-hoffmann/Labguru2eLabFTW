...
def download_attachment(attachment_info):
	...
	while filename in list_of_all_attachments:
		...
		intermit_filename = "another_" + intermit_filename
		filename = download_path + intermit_filename
...
def download_experiment(project_number):
	...
	if witnessed:
		eLabFTW_metadata["extra_fields"]["witnessed_at"] = {"type":"text", "value":signed_at, "group_id":1}
		eLabFTW_metadata["extra_fields"]["witnessed_by"] = {"type":"text", "value":signed_by, "group_id":1}
	if start_date != "null":
...
if __name__ == "__main__":
	...
	projects_file = "../ressourcen/experiments_downloaded_specificExperiments.tsv"
	projects_downloaded = []
	...
	for project_number in list_of_project_numbers:
		...
		if project_number in ["1008411", "1069681", "1008631", "1008671", "1009001", "1009021", "1009311", "1008891", "1001021", "1001031", "1008591", "1008811", "1002671", "1007371", "1007381", "1008081", "1008091", "1007791", "1007801", "1009451", "1009981", "1009811", "1009811", "1008111", "1005411", "1007361", "1007721", "1007901", "1008661", "1008701", "1008711", "1007821", "1008131", "1008241", "1008321", "1008601", "1008691","1008851", "1009921", "1007581", "1008461"]:
			continue
		counter += 1
		if counter == 800:
			break
