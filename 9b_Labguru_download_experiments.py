...
if __name__ == "__main__":
	...
	counter = 0
	#list_of_project_numbers == [1024731]
	for project_number in list_of_project_numbers:
		if project_number != "1024731":
			continue
		print("Now working on experiment " + str(project_number))
		
		#if project_number in ["1008411", "1069681", "1008631", "1008671", "1009001", "1009021", "1009311"]:
		#	continue
		counter += 1
		if counter == 4000:
			download_path="../ressourcen/experiment_attachments_6/"
			list_of_all_attachments = []
		elif counter == 4500:
			download_path="../ressourcen/experiment_attachments_7/"
			list_of_all_attachments = []
		elif counter == 5000:
			download_path="../ressourcen/experiment_attachments_8/"
			list_of_all_attachments = []
		elif counter == 5500:
			download_path="../ressourcen/experiment_attachments_9/"
			list_of_all_attachments = []
		elif counter == 6000:
			download_path="../ressourcen/experiment_attachments_10/"
			list_of_all_attachments = []
		if project_number in projects_downloaded:
			...
			try:
				...
				with open("these_experiments_did_not_work_LabguruDownload_2.txt", "a") as f:
